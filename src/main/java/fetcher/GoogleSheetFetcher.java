...
public class GoogleSheetFetcher {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GoogleSheetFetcher.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    static ValueRange fetchValuesFromGoogleSheet() throws GeneralSecurityException, IOException {
